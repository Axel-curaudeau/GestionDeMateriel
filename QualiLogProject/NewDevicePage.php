...
<body style="height:100vh;display:flex;justify-content:center;align-items:center;">
    ...
    <form action="NewDevice.php" method="POST">
        <div class="container" align="left">  
            ...
            <input type="text" placeholder="iPhone 14 Pro Max" name="nom" required>
            <label for="version">Version</label>
            <input type="text" placeholder="8.2" name="version" required>
            <label for="reference">Référence</label>
            <input type="text" placeholder="AP123" name="reference" required pattern="[A-Z]{2}[0-9]{3}">
            <label for="number">Numéro de Téléphone</label>
            <input type="text" placeholder="(+33)601020304" name="number" required pattern="\(\+[0-9]{1,3}\)[0-9]{9}">
